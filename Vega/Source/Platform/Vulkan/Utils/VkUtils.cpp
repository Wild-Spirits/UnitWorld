...
namespace LM
{
    ...
    std::string VkResultString(VkResult _Result, bool _GetExtended)
    {
        ...
        {
            default:
            case VK_SUCCESS: return !_GetExtended ? "VK_SUCCESS" : "VK_SUCCESS Command successfully completed";
            case VK_NOT_READY:
                return !_GetExtended ? "VK_NOT_READY" : "VK_NOT_READY A fence or query has not yet completed";
            case VK_TIMEOUT:
                return !_GetExtended ? "VK_TIMEOUT"
                                     : "VK_TIMEOUT A wait operation has not completed in the specified time";
            case VK_EVENT_SET: return !_GetExtended ? "VK_EVENT_SET" : "VK_EVENT_SET An event is signaled";
            case VK_EVENT_RESET: return !_GetExtended ? "VK_EVENT_RESET" : "VK_EVENT_RESET An event is unsignaled";
            case VK_INCOMPLETE:
                return !_GetExtended ? "VK_INCOMPLETE" : "VK_INCOMPLETE A return array was too small for the result";
            case VK_SUBOPTIMAL_KHR:
                return !_GetExtended
                         ? "VK_SUBOPTIMAL_KHR"
            ...
            case VK_THREAD_DONE_KHR:
                return !_GetExtended ? "VK_THREAD_DONE_KHR"
            ...
            case VK_OPERATION_DEFERRED_KHR:
                return !_GetExtended
                         ...
                         : "VK_OPERATION_DEFERRED_KHR A deferred operation was requested and at least some of "
            ...
            // Error codes
            case VK_ERROR_OUT_OF_HOST_MEMORY:
                return !_GetExtended ? "VK_ERROR_OUT_OF_HOST_MEMORY"
                                     : "VK_ERROR_OUT_OF_HOST_MEMORY A host memory allocation has failed.";
            case VK_ERROR_OUT_OF_DEVICE_MEMORY:
                return !_GetExtended ? "VK_ERROR_OUT_OF_DEVICE_MEMORY"
            ...
            case VK_ERROR_MEMORY_MAP_FAILED:
                return !_GetExtended ? "VK_ERROR_MEMORY_MAP_FAILED"
            ...
            case VK_ERROR_EXTENSION_NOT_PRESENT:
                return !_GetExtended ? "VK_ERROR_EXTENSION_NOT_PRESENT"
                                     : "VK_ERROR_EXTENSION_NOT_PRESENT A requested extension is not supported.";
            case VK_ERROR_FEATURE_NOT_PRESENT:
                return !_GetExtended ? "VK_ERROR_FEATURE_NOT_PRESENT"
            ...
            case VK_ERROR_SURFACE_LOST_KHR:
                return !_GetExtended ? "VK_ERROR_SURFACE_LOST_KHR"
            ...
            case VK_ERROR_OUT_OF_POOL_MEMORY:
                return !_GetExtended
                         ...
                         : "VK_ERROR_OUT_OF_POOL_MEMORY A pool memory allocation has failed. This must only be "
                           "returned if no attempt to allocate host or device memory was made to accommodate "
                           "the new allocation. If the failure was definitely due to fragmentation of the "
            ...
            // NOTE: Same as above
            // case VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS:
            //    return !_GetExtended ? "VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS"
            //    :"VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS A buffer creation or memory allocation failed because the
            //    requested address is not available. A shader group handle assignment failed because the requested
            ...
            case VK_ERROR_VALIDATION_FAILED_EXT:
                return !_GetExtended ? "VK_ERROR_VALIDATION_FAILED_EXT"
